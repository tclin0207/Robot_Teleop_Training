...
class videoThread(threading.Thread):
    def __init__(self, threadID, name, ip_addr):
        ...
        self.controller_img = cv2.resize(self.controller_img, (240, 160), interpolation = cv2.INTER_AREA)
        # cv2.imshow('test',self.controller_img[:,:,3])

        self.cap_rs1 = cv2.VideoCapture(
            'v4l2src device=/dev/video0 ! videoscale ! video/x-raw,width=800,height=450,framerate=30/1 ! decodebin ! videoconvert ! appsink', cv2.CAP_GSTREAMER)
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            ret_rs1, frame_rs1 = self.cap_rs1.read()
            ...
            background_subsection = frame_rs1[270:270+h, 500:500+w]
            composite = background_subsection * (1 - alpha_mask) + overlay_colors * alpha_mask
            frame_rs1[270:270+h, 500:500+w] = composite
