...
class videoThread(threading.Thread):
    def __init__(self, threadID, name, ip_addr):
        ...
        # self.rgb_img = np.zeros((540, 960, 3), np.uint8)
        ...
        self.out_send = cv2.VideoWriter(
            ...
            cv2.CAP_GSTREAMER, 0, 25, (800, 450))
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            # thick_rec = 2
            # resized_frame = cv2.resize(frame_rs1, (240, 135), interpolation = cv2.INTER_AREA) # (400, 225)            
            # frame_rs2[2:137, 398:638] = resized_frame # [2:227, 558:958]
            # cv2.rectangle(frame_rs2, (398,137), (638,2), color_rec, thick_rec) # (558,227), (958,2)
